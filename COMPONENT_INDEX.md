...
> 169 components exported from carbon-components-svelte@0.95.1.
...
| title           | No       | <code>let</code> | No       | <code>string</code>  | <code>"title"</code>           | Specify the title of the accordion item heading.<br />Alternatively, use the "title" slot.<br />@example <br />`svelte<br />&lt;AccordionItem&gt;<br />  &lt;div slot="title"&gt;Custom Title&lt;/div&gt;<br />&lt;/AccordionItem&gt;<br />` |
...
| code                  | No       | <code>let</code> | No       | <code>string</code>                                  | <code>undefined</code>                           | Set the code snippet text.<br />Alternatively, use the default slot.<br /><br />NOTE: you _must_ use the `code` prop for the copy-to-clipboard functionality.<br />@example <br />`svelte<br />&lt;CodeSnippet&gt;{code}&lt;/CodeSnippet&gt;<br />` |
...
| Prop name     | Required | Kind             | Reactive | Type                                                                                               | Default value          | Description                                                                                                                                                                                                                                               |
| :------------ | :------- | :--------------- | :------- | -------------------------------------------------------------------------------------------------- | ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| as            | No       | <code>let</code> | No       | <code>boolean</code>                                                                               | <code>false</code>     | Set to `true` to render a custom HTML element.<br />Props are destructured as `props` in the default slot.<br />@example <br />`svelte<br />&lt;Column let:props&gt;<br />  &lt;article {...props}&gt;Content&lt;/article&gt;<br />&lt;/Column&gt;<br />` |
...
| typeahead                | No       | <code>let</code>      | No       | <code>boolean</code>                                                                                  | <code>false</code>                               | Set to `true` to enable autocomplete with typeahead                                                                                                                                                                                                                                                                     |
| shouldFilterItem         | No       | <code>let</code>      | No       | <code>(item: Item, value: string) => boolean</code>                                                   | --                                               | Determine if an item should be filtered given the current combobox value.<br />Will be ignored if `typeahead` is enabled.                                                                                                                                                                                               |
...
| clear                    | No       | <code>function</code> | No       | <code>(options?: { focus?: boolean; }) => void</code>                                                 | --                                               | Clear the combo box programmatically<br />@example <br />`svelte<br />&lt;ComboBox bind:this={comboBox} items={items} /&gt;<br />&lt;button on:click={() =&gt; comboBox.clear()}&gt;Clear&lt;/button&gt;<br />&lt;button on:click={() =&gt; comboBox.clear({ focus: false })}&gt;Clear (No Focus)&lt;/button&gt;<br />` |
...
| labelText    | No       | <code>let</code> | No       | <code>string</code>                    | <code>""</code>                                  | Specify the label text.<br />Alternatively, use the "labelText" slot.<br />@example <br />`svelte<br />&lt;ContextMenuOption&gt;<br />  &lt;span slot="labelChildren"&gt;Custom Label&lt;/span&gt;<br />&lt;/ContextMenuOption&gt;<br />` |
...
| tableHeaderTranslateWithId | No       | <code>let</code> | No       | <code>(id: import("./TableHeader.svelte").TableHeaderTranslationId) => string</code> | <code>undefined</code>                           | Override the default table header translation ids.                                                                                                                                                     |
...
| clearFiles       | No       | <code>const</code> | No       | <code>() => void</code>                                            | --                                      | Programmatically clear the uploaded files.<br />@example <br />`svelte<br />&lt;FileUploader bind:this={uploader} bind:files={files} /&gt;<br />&lt;button on:click={() =&gt; uploader.clearFiles()}&gt;Clear Files&lt;/button&gt;<br />`                         |
| labelTitle       | No       | <code>let</code>   | No       | <code>string</code>                                                | <code>""</code>                         | Specify the label title.<br />Alternatively, use the named slot "labelTitle".<br />@example <br />`svelte<br />&lt;FileUploader&gt;<br />  &lt;span slot="labelTitle"&gt;Custom Label&lt;/span&gt;<br />&lt;/FileUploader&gt;<br />`                              |
| labelDescription | No       | <code>let</code>   | No       | <code>string</code>                                                | <code>""</code>                         | Specify the label description.<br />Alternatively, use the named slot "labelDescription".<br />@example <br />`svelte<br />&lt;FileUploader&gt;<br />  &lt;span slot="labelDescription"&gt;Custom description text&lt;/span&gt;<br />&lt;/FileUploader&gt;<br />` |
...
| Prop name     | Required | Kind             | Reactive | Type                 | Default value      | Description                                                                                                                                                                                                                                         |
| :------------ | :------- | :--------------- | :------- | -------------------- | ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| as            | No       | <code>let</code> | No       | <code>boolean</code> | <code>false</code> | Set to `true` to render a custom HTML element.<br />Props are destructured as `props` in the default slot.<br />@example <br />`svelte<br />&lt;Grid let:props&gt;<br />  &lt;header {...props}&gt;Content&lt;/header&gt;<br />&lt;/Grid&gt;<br />` |
...
| text                       | No       | <code>let</code> | No       | <code>string</code>                                               | <code>undefined</code>         | Specify the text displayed next to the icon.<br />Alternatively, use the named slot "text".<br />@example <br />`svelte<br />&lt;HeaderAction&gt;<br />  &lt;div slot="text"&gt;Custom Text&lt;/div&gt;<br />&lt;/HeaderAction&gt;<br />` |
...
| loadImage | No       | <code>const</code> | No       | <code>(url?: string) => void</code>                                                                             | --                     | Method invoked to load the image provided a `src` value<br />@example <br />`svelte<br />&lt;ImageLoader bind:this={loader} src="default.jpg" /&gt;<br />&lt;button on:click={() =&gt; loader.loadImage("new-image.jpg")}&gt;<br />  Load New Image<br />&lt;/button&gt;<br />` |
...
| clearItem | No       | <code>function</code> | No       | <code>() => void</code> | --                               | Remove the persisted key value from the browser's local storage<br />@example <br />`svelte<br />&lt;LocalStorage bind:this={storage} key="my-key" bind:value={data} /&gt;<br />&lt;button on:click={() =&gt; storage.clearItem()}&gt;Clear Item&lt;/button&gt;<br />` |
| clearAll  | No       | <code>function</code> | No       | <code>() => void</code> | --                               | Clear all key values from the browser's local storage<br />@example <br />`svelte<br />&lt;LocalStorage bind:this={storage} key="my-key" bind:value={data} /&gt;<br />&lt;button on:click={() =&gt; storage.clearAll()}&gt;Clear All Storage&lt;/button&gt;<br />`     |
...
| formId                     | No       | <code>let</code> | No       | <code>string</code>                                 | <code>undefined</code>                           | Specify the ID of a form element to associate with the primary button.<br />This enables the primary button to submit the form from outside the form element. |
...
| Prop name     | Required | Kind             | Reactive | Type                 | Default value      | Description                                                                                                                                                                                                                                         |
| :------------ | :------- | :--------------- | :------- | -------------------- | ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| as            | No       | <code>let</code> | No       | <code>boolean</code> | <code>false</code> | Set to `true` to render a custom HTML element.<br />Props are destructured as `props` in the default slot.<br />@example <br />`svelte<br />&lt;Row let:props&gt;<br />  &lt;section {...props}&gt;Content&lt;/section&gt;<br />&lt;/Row&gt;<br />` |
| condensed     | No       | <code>let</code> | No       | <code>boolean</code> | <code>false</code> | Set to `true` to use the condensed variant                                                                                                                                                                                                          |
| narrow        | No       | <code>let</code> | No       | <code>boolean</code> | <code>false</code> | Set to `true` to use the narrow variant                                                                                                                                                                                                             |
| noGutter      | No       | <code>let</code> | No       | <code>boolean</code> | <code>false</code> | Set to `true` to remove the gutter                                                                                                                                                                                                                  |
| noGutterLeft  | No       | <code>let</code> | No       | <code>boolean</code> | <code>false</code> | Set to `true` to remove the left gutter                                                                                                                                                                                                             |
...
| invalid        | No       | <code>let</code> | No       | <code>boolean</code>                    | <code>false</code>                               | Set to `true` to indicate an invalid state                                                                                                                                                                          |
| labelText      | No       | <code>let</code> | No       | <code>string</code>                     | <code>""</code>                                  | Specify the label text.<br />Alternatively, use the "labelText" slot.<br />@example <br />`svelte<br />&lt;Slider&gt;<br />  &lt;span slot="labelChildren"&gt;Custom Label&lt;/span&gt;<br />&lt;/Slider&gt;<br />` |
| hideLabel      | No       | <code>let</code> | No       | <code>boolean</code>                    | <code>false</code>                               | Set to `true` to visually hide the label text                                                                                                                                                                       |
...
| label     | No       | <code>let</code> | No       | <code>string</code>                        | <code>""</code>                                  | Specify the tab label.<br />Alternatively, use the default slot.<br />@example <br />`svelte<br />&lt;Tab&gt;<br />  &lt;span&gt;Label&lt;/span&gt;<br />&lt;/Tab&gt;<br />` |
| href      | No       | <code>let</code> | No       | <code>string</code>                        | <code>"#"</code>                                 | Specify the href attribute                                                                                                                                                   |
...
| :---------- | :------- | :--------------- | :------- | --------------------------------------------- | ------------------------------------------------ | ---------------------------------------------------------------------------------------------------------- |
| ref         | No       | <code>let</code> | Yes      | <code>null &#124; HTMLInputElement</code>     | <code>null</code>                                | Obtain a reference to the input HTML element                                                               |
| value       | No       | <code>let</code> | Yes      | <code>null &#124; number &#124; string</code> | <code>""</code>                                  | Specify the input value.<br /><br />`value` will be set to `null` if type="number" and the value is empty. |
| size        | No       | <code>let</code> | No       | <code>"sm" &#124; "xl"</code>                 | <code>undefined</code>                           | Set the size of the input.                                                                                 |
| placeholder | No       | <code>let</code> | No       | <code>string</code>                           | <code>""</code>                                  | Specify the placeholder text                                                                               |
| light       | No       | <code>let</code> | No       | <code>boolean</code>                          | <code>false</code>                               | Set to `true` to enable the light variant                                                                  |
| disabled    | No       | <code>let</code> | No       | <code>boolean</code>                          | <code>false</code>                               | Set to `true` to disable the input                                                                         |
...
| icon            | No       | <code>let</code> | No       | <code>any</code>                                                | <code>Information</code>                         | Specify the icon to render for the tooltip button.<br />Defaults to `&lt;Information /&gt;`. |
...
| nodes         | No       | <code>let</code>      | No       | <code>ReadonlyArray<Node></code>                                 | <code>[]</code>        | Provide an array of nodes to render.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| size          | No       | <code>let</code>      | No       | <code>"default" &#124; "compact"</code>                          | <code>"default"</code> | Specify the TreeView size.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| labelText     | No       | <code>let</code>      | No       | <code>string</code>                                              | <code>""</code>        | Specify the label text                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| hideLabel     | No       | <code>let</code>      | No       | <code>boolean</code>                                             | <code>false</code>     | Set to `true` to visually hide the label text                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| expandAll     | No       | <code>function</code> | No       | <code>() => void</code>                                          | --                     | Programmatically expand all nodes<br />@example <br />`svelte<br />&lt;TreeView bind:this={treeView} {nodes} /&gt;<br />&lt;button on:click={() =&gt; treeView.expandAll()}&gt;Expand All&lt;/button&gt;<br />`                                                                                                                                                                                                                                                                                                                                 |
| collapseAll   | No       | <code>function</code> | No       | <code>() => void</code>                                          | --                     | Programmatically collapse all nodes<br />@example <br />`svelte<br />&lt;TreeView bind:this={treeView} {nodes} /&gt;<br />&lt;button on:click={() =&gt; treeView.collapseAll()}&gt;Collapse All&lt;/button&gt;<br />`                                                                                                                                                                                                                                                                                                                           |
| expandNodes   | No       | <code>function</code> | No       | <code>(filterNode?: (node: Node) => boolean) => void</code>      | --                     | Programmatically expand a subset of nodes.<br />Expands all nodes if no argument is provided<br />@example <br />`svelte<br />&lt;TreeView bind:this={treeView} {nodes} /&gt;<br />&lt;button on:click={() =&gt; treeView.expandNodes((node) =&gt; node.id.startsWith('folder-'))}&gt;<br />  Expand Folders<br />&lt;/button&gt;<br />`                                                                                                                                                                                                        |
| collapseNodes | No       | <code>function</code> | No       | <code>(filterNode?: (node: Node) => boolean) => void</code>      | --                     | Programmatically collapse a subset of nodes.<br />Collapses all nodes if no argument is provided<br />@example <br />`svelte<br />&lt;TreeView bind:this={treeView} {nodes} /&gt;<br />&lt;button on:click={() =&gt; treeView.collapseNodes((node) =&gt; node.id.startsWith('folder-'))}&gt;<br />  Collapse Folders<br />&lt;/button&gt;<br />`                                                                                                                                                                                                |
| showNode      | No       | <code>function</code> | No       | <code>(id: TreeNodeId, options?: ShowNodeOptions) => void</code> | --                     | Programmatically show a node by `id`.<br />By default, the matching node will be expanded, selected, and focused.<br />Use the options parameter to customize this behavior.<br />@example <br />`svelte<br />&lt;TreeView bind:this={treeView} {nodes} /&gt;<br />&lt;button on:click={() =&gt; treeView.showNode('node-123')}&gt;<br />  Show Node<br />&lt;/button&gt;<br />&lt;button on:click={() =&gt; treeView.showNode('node-123', { expand: false, focus: false })}&gt;<br />  Show Node (No Expand/Focus)<br />&lt;/button&gt;<br />` |
...
| Event name | Type       | Detail                                                                      | Description |
| :--------- | :--------- | :-------------------------------------------------------------------------- | :---------- |
| select     | dispatched | <code>Node & { expanded: boolean; leaf: boolean; selected: boolean }</code> | --          |
| toggle     | dispatched | <code>Node & { expanded: boolean; leaf: boolean; selected: boolean }</code> | --          |
| focus      | dispatched | <code>Node & { expanded: boolean; leaf: boolean; selected: boolean }</code> | --          |
| keydown    | forwarded  | --                                                                          | --          |
