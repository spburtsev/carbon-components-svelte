...
| expandNodes   | No       | <code>function</code> | No       | <code>(filterId?: (node: TreeNode) => boolean) => void</code>    | --                     | Programmatically expand a subset of nodes.<br />Expands all nodes if no argument is provided<br />@example <br />`svelte<br />&lt;TreeView bind:this={treeView} {nodes} /&gt;<br />&lt;button on:click={() =&gt; treeView.expandNodes((node) =&gt; node.id.startsWith('folder-'))}&gt;<br />  Expand Folders<br />&lt;/button&gt;<br />`                                                                                                                                                                                                        |
| collapseNodes | No       | <code>function</code> | No       | <code>(filterId?: (node: TreeNode) => boolean) => void</code>    | --                     | Programmatically collapse a subset of nodes.<br />Collapses all nodes if no argument is provided<br />@example <br />`svelte<br />&lt;TreeView bind:this={treeView} {nodes} /&gt;<br />&lt;button on:click={() =&gt; treeView.collapseNodes((node) =&gt; node.id.startsWith('folder-'))}&gt;<br />  Collapse Folders<br />&lt;/button&gt;<br />`                                                                                                                                                                                                |
